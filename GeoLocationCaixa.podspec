...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GeoLocationCaixa.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Lucas Veras Aguiar Cardoso/GeoLocationCaixa'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Lucas Veras Aguiar Cardoso' => 'lucas.a.cardoso@capgemini.com' }
  s.source           = { :git => 'https://github.com/Lucas Veras Aguiar Cardoso/GeoLocationCaixa.git', :tag => s.version.to_s }
